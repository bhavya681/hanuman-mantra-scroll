  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "divine-glow": "hsl(var(--divine-glow))",
        "sacred-shadow": "hsl(var(--sacred-shadow))",
      },
      fontFamily: {
        'sanskrit': ['"Tiro Devanagari Sanskrit"', 'serif'],
        'vedic': ['Cinzel', 'serif'],
        'ancient': ['"Cormorant Garamond"', 'serif'],
      },
      backgroundImage: {
      ...
      animation: {
        ...
        "verse-reveal": "verse-reveal 0.6s cubic-bezier(0.4, 0, 0.2, 1) forwards",
